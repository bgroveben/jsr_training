...
pp 28 Some Notes About The Controller
...
* After unsuccessfully trying to use Rails 4.0.13, I now have a test/helpers/pages_helper_test.rb file. Let's see what happens.
